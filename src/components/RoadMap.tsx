function RoadMap() {
  return (
    <>
      <div className="lgg:h-[80vh] h-[100vh] w-full flex flex-col items-center lgg:gap-40 gap-20 mt-20 lgg:mt-0 animate-appears-anim-l animation-timeline animation-range">
